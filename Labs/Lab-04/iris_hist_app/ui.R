...
shinyUI(
    pageWithSidebar(
        headerPanel('Распределение характеристик цветков'),# название приложения
        ...
        mainPanel(                       # главная область
            textOutput('sp.text'),       # текстовый объект для отображения
            plotOutput('sp.hist'))))     # гистограммы переменных
