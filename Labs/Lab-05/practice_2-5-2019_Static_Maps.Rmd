...
1. Карта-хороплет регионов РФ, входящих в состав Приволжского федерального округа, построенная функцией `spplot()` по данным сборников "Регионы России" за последний доступный год [^19].    
