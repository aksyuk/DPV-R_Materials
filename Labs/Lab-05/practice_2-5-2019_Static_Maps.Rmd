...
\ \ \ \ \ **Пример №2**. Построим картограмму регионов Республики Беларусь, раскрасив регионы по значениям непрерывного количественного показателя. Код основан на примере из книги [^15].    

\ \ \ \ \ На сайте <www.belstat.gov.by> приводится официальная статистика социально-экономических показателей Республики Беларусь. Сборник «Регионы Республики Беларусь, 2015» [^16] [^17] содержит годовую статистику на конец 2014 года в разрезе регионов. Несколько показателей за 2014 год сохранены в файле с расширением «.csv», размещённом на <github.com/aksyuk>.    
...
stat.Regions <- read.csv(fileURL,               # ссылка
                         sep = ';', dec = ',',  # разделители
...
\ \ \ \ \ С помощью «knitr» создать html-отчёт с короткими пояснениями к данным и с картой, построенной двумя способами: 1) функцией `spplot()`; 2) функцией `ggplot()` (данные по вариантам, которые перечислены ниже). В отчёт включить код загрузки данных. Данные можно взять из сборников Росстата «Регионы России: социально-экономические показатели» [^20] и сохранить в .csv файле в репозитории на github, либо загружить данные в R напрямую с Росстата функцией из репозитория: <https://github.com/nillsondg/r_gks_stat_data>. Разместить отчёт на RPubs, его код – на github, и отправить ссылки на них на почту s.aksuk@kiber-guu.ru.   

\ \ \ \ \ Распределение баллов за задание:    

* есть код загрузки данных:4 балла;   

* есть график: 5 баллов;   

* отчёт размещён на RPubs: 2 балла.   

\ \ \ \ \ **Варианты:**    

1. Карта-хороплет регионов РФ, показатель – любой из раздела «Население».   

1. Карта-хороплет регионов РФ, показатель – любой из раздела «Труд».   

1.	Карта-хороплет регионов РФ, показатель – любой из раздела «Уровень жизни населения».   

1.	Карта-хороплет регионов РФ, показатель – любой из раздела «Образование».   

1.	Карта-хороплет регионов РФ, показатель – любой из раздела «Здравоохрание».    
1.	Карта-хороплет регионов РФ, показатель – любой из раздела «Окружающая среда».   

1.	Карта-хороплет регионов РФ, показатель – любой из раздела «Валовой региональный продукт».   

1.	Карта-хороплет регионов РФ, показатель – любой из раздела «Сельское и лесное хозяйство».   

1.	Карта-хороплет регионов РФ, показатель – любой из раздела «Транспорт».   

1.	Карта-хороплет регионов РФ, показатель – любой из раздела «Наука и инновации».   

1.	Карта-хороплет регионов РФ, показатель – любой из раздела «Промышленное производство».   

1.	Карта-хороплет регионов РФ, показатель – любой из раздела «Строительство».   
