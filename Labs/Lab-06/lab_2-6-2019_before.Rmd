...
На этой карте показано расположение аптек в г.Уренгой. Список аптек получен с Портала открытых данных РФ, географические координаты определены по адремас с помощью API Яндекс Геокодера.    
